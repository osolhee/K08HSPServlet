...
<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<%--
선언부(Declaration) : 스크립트릿이나 표현식에서 사용할 메서드를 선언할때 사용된다.
	선언부에서 선언된 메서드는 해당 JSP가 서블릿(Java파일)으러 변환될때 
	멤버메서드 형태로 선언된다.
 --%>
<%!
...
<body>
<!-- 
	스트립트렛(Scriptlet) : 주로 JSP코드를 작성하고 실행할때 사용한다.
	...
	표현식(Expression) : 변수를 웹브라우저상에 출력할 때 사용한다.
		JS의 document.write()와 동일한 역활을 한다. 표현식 사용시 주의할 점은
...
<%
	//해당 메서드는 static이므로 객체 생성 없이 호출 할 수 있다.
